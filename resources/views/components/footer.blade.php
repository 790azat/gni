<div class="col-12 bg-dark gap-2 d-flex flex-wrap justify-content-center align-items-center text-light p-3">
    <a href="{{ route('company-register') }}" class="text-hover btn me-2" style="background: #3b3b3b">
...
{{--    </div>--}}
{{--    <div>--}}
{{--        <img src="{{ asset('images/arca.png') }}" style="width: 100px" alt="">--}}
{{--    </div>--}}
{{--    <div>--}}
{{--        <img src="{{ asset('images/mastercard.png') }}" style="width: 100px" alt="">--}}
{{--    </div>--}}
</div>
