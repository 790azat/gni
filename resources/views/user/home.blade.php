            ...
            <div class="col-12 d-flex gap-2 flex-wrap">
                <div class="col p-3 d-none d-sm-flex flex-wrap justify-content-center align-content-center bg-white rounded-1 border border-1 border-opacity-10 border-secondary">
                    <div class="col-12 d-flex justify-content-start mb-2">
                        <p class="text-secondary">Անուն: <span class="text-dark"> {{$user->name}}</span></p>
                    </div>
                    <div class="col-12 d-flex justify-content-start mb-2">
                        <p class="text-secondary">Ազգանուն: <span class="text-dark"> {{$user->surname}}</span></p>
                    </div>
                    <div class="col-12 d-flex justify-content-start mb-2">
                        <p class="text-secondary">Գրանցումը: <span class="text-dark text-decoration-underline">
            ...
            <div class="col-12 d-flex gap-2 flex-wrap">
                <div class="col-12 col-sm p-3 d-flex flex-wrap justify-content-center align-content-start bg-white rounded-1 border border-1 border-opacity-10 border-secondary">
                    <div class="col-12 d-flex justify-content-start pt-2">
                        <p class="text-secondary">Էլ. հասցե: <span class="text-dark"> {{$user->email}}</span></p>
                    </div>
                    <div class="col-12 d-flex justify-content-start border-bottom border-1 border-opacity-10 border-secondary pb-2">
                        @if($user->email_verified_at !== null)
                            <p class="text-success"><i class="fa-solid fa-circle-check me-1"></i> Հաստատված</p>
                        @else
                            <p class="text-danger text-nowrap"><i class="fa-solid fa-circle-exclamation me-1"></i>
                                Չհաստատված <div data-bs-toggle="modal" data-bs-target="#addMailModal"><span class="ms-1 text-primary text-decoration-underline" style="cursor: pointer"> Հաստատել</span></div></p>
                            <!-- Modal -->
                            <div class="modal fade" id="addMailModal" tabindex="-1" aria-labelledby="addMailModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Էլ. հասցեն</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body py-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Փակել</button>
                                            <a href="/resend/{{$user->id}}/{{$user->email}}"><button type="button" class="btn btn-primary">Ուղղարկել նամակ</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 d-flex justify-content-start pt-2">
                        <p class="text-secondary">Հեռախոս: <span class="text-dark"> {{$user->phone}}</span></p>
                    </div>
                    <div class="col-12 d-flex justify-content-start">
                        ...
                        @else
                        <p class="text-danger text-nowrap"><i class="fa-solid fa-circle-exclamation me-1"></i>
                            Չհաստատված <div data-bs-toggle="modal" data-bs-target="#addPhoneModal"><span class="ms-1 text-primary text-decoration-underline" style="cursor: pointer"> Հաստատել</span></div></p>
                        @endif
                        <!-- Modal -->
                        <div class="modal fade" id="addPhoneModal" tabindex="-1" aria-labelledby="addPhoneModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Հեռախոսահամարը</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                        ...
                                        <div class="col-10 mx-auto">
                                            <form action="/send" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <button class="btn btn-primary" type="submit" id="button-addon2">@if($user->phone !== null) Կրկին ուղղարկել @else Ուղղարկել նամակ @endif</button>
                                                </div>
                                            </form>
                                            @if($user->phone !== null)
                                                <form action="/verify_phone" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-text">Կոդ</div>
                                                        ...
                                                        <button class="btn btn-primary" type="submit" id="button-addon3">Հաստատել</button>
                                                    </div>
                                                </form>
                                            @endif
                                        </div>
                ...
                <div class="col-12 col-sm p-3 d-flex flex-wrap justify-content-center align-content-center bg-white rounded-1 border border-1 border-opacity-10 border-secondary">
                    <p class="px-2">Խնդրում ենք լրացնել ձեր պրոֆիլը, և մենք ձեզ խորհուրդ կտանք հետաքրքիր առաջարկներ, ինչպես նաև նվերներ կտանք ծննդյան և տոների կապակցությամբ</p>
                </div>
            </div>
        </div>
    </div>
