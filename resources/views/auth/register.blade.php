        ...
        <div class="row justify-content-center">
            <div class="col-11 col-lg-8 shadow d-flex p-0">
                ...
                <form class="col-sm-7 d-flex p-5 px-4 px-sm-5 pt-4 pb-3 bg-light flex-wrap align-content-center" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="col-12 mb-1 d-flex gap-3">
                        <div class="col">
                            <div class="col-12 mb-1">
                                <label for="name" class="fw-bold">Անուն</label>
                            </div>
                        ...
                        <div class="col-7">
                            <div class="col-12 mb-1">
                                <label for="surname" class="fw-bold">Ազգանուն</label>
                            </div>
                            <div class="col-12 mb-2">
                    ...
                    <div class="col-12 mb-1">
                        <label for="phone" class="fw-bold">Հեռախոս</label>
                    </div>
                    <div class="col-12 mb-1">
                    ...
                    <div class="col-12 mb-1">
                        <label for="password" class="fw-bold">Ծածկագրի</label>
                    </div>
                    <div class="col-12 mb-1">
                    ...
                    <div class="col-12 mb-1">
                        <label for="password-confirm" class="fw-bold">Հաստատել ծածկագիրը</label>
                    </div>
                    <div class="col-12 mb-4">
                        <input id="password-confirm" placeholder="Confirm password" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                    </div>
                    <div class="col-12 mb-3">
                        <button type="submit" class="btn btn-success col-12">Գրացվել</button>
                    </div>
                </form>
            </div>
        </div>
